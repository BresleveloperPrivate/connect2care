const translationEN = {
    ...
    "initiateMeetingQ": "What does it mean to initiate a meeting?",
    "createdMeetingQ": "I created a meeting, what now?",
    "inviteToMeetingQ": "How do I invite people to a meeting?",
    "registrationForMyMeetingQ": "How is registration for my meeting done?",
    "openMeetingQ": "What does it mean to have an open meeting?",
    "closedMeetingQ": "What does a closed meeting mean?",
    "couldNotSignUpQ": "I couldn't sign up, what to do?",
    "emailFromZoomQ": "I got an email from zoom, what to do?",
    "doNotSeeTheMeetingQ": "I created a meeting but I don't see it on a list of meetings, why?",
    "additionalLanguagesQ": "Can I speak additional languages?",
    "moreThanOneMeetingQ": "Can I have more than one meeting?",
    "joinMeetingQ": "How do I join the meeting?",
    "maxAndMinParticipantsQ": "What is the maximum and minimum of participants in the meeting?",
    "fewFallenQ": "Can I have a meeting of a few fallen?",
    "guidanceZoom&buildTheNightQ": "I've never delivered an online meeting. Do you have any guidance on zoom and building the night?",
    "successfulMeetingQ": "What should you prepare for a successful meeting?",
    "behindTheProjectQ": "who are you? Who is behind the project?",
    "allAgesQ": "Is the project appropriate for all ages?",
    "meetingCanceledQ": "My meeting has been canceled, what am I doing?",
    "playVideoQ": "I want to play a video during the meeting, how do I do it?",
    "differentMeetingsQ": "What are our brothers meetings? Abihai House Meetings?",


    "initiateMeetingA": "A person close to the victim (s) (e.g. family or team member) responsible for meeting planning, content preparation, and invitation of participants.",
    "inviteToMeetingA": "To invite more attendees to your meeting, all you have to do is log in to your meeting - and click the 'Invite to Meet' button - this is, now copy the link to your Wetsap groups, Facebook wall and email - and invite family and friends.",
    "openMeetingA": "A meeting that is open to anyone, anywhere.",
    "closedMeetingA": "A meeting scheduled for participants (e.g., family or class).",
    ...
    "meetingCanceledA": "There can be a situation where the initiator of the meeting cancels the meeting, in which case you will receive an email alerting you. You can enter the list of meetings and select a new meeting.",
    "differentMeetingsA": `'Our brothers' meetings, these are special meetings created in various collaborations and meetings of the Abihai House, these are meetings created by the Abihai House as part of the Interior Day Memorial project.`
