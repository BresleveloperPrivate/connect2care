        ...
        return (<>
            ...
            <Suspense fallback={<div>Loading...</div>}>
                <Router>
                    ...
                    <div className="App">
                        <Route path="/(meeting|create-meeting|success|edit-meeting|share|meetings|my-meetings)/" render={props => <NavBar history={this.props.history} t={this.props.t} className={'navbar-opening'} {...props} />} />
                        <Route path="/" exact render={props => <NavBar t={this.props.t} history={this.props.history} className={'navbar-opening'} {...props} />} />
                        <Switch>
