        ...
        <div style={{ marginTop: '6vh' }}>
            {props.CreateMeetingStore.res ?
                <div style={{ textAlign: "right" }} className="CreateMeeting">
                    ...
                    <div>
                        ...
                        <div className='d-flex align-items-center pb-4' style={{ marginRight: '6vw' }}>
                            {!props.CreateMeetingStore.meetingDetails.approved && props.CreateMeetingStore.meetingDetails.owner.email &&
                                <div
                                    onClick={() => props.CreateMeetingStore.approveMeeting(props.CreateMeetingStore.meetingDetails.owner.email, props.CreateMeetingStore.meetingDetails.owner.phone, props.CreateMeetingStore.meetingDetails.owner.name)}
                                    className="grow"
                    ...
                    <div className='d-flex align-items-center pb-5 pt-4' style={{ float: 'left', flexWrap: 'wrap' }}>
